...
class TestClassPyTestScoringBoard:
    ...
    def test_making_go_board_strings(self):
        ...
        the_board.__class__ = sb.ScoringBoard
        the_board.pieces_into_sets()
        the_board.making_go_board_strings(the_board.black_set, cf.unicode_black, False)
        the_board.making_go_board_strings(the_board.white_set, cf.unicode_white, False)
        the_board.making_go_board_strings(the_board.empty_space_set, cf.unicode_none, False)
        ...
        assert str(the_board.black_strings[0]) == "this is a board string of color (0, 0, 0) and with len of 12 and values [(5, 0), (5, 1), (6, 0), (6, 2), (6, 3), (7, 0), (7, 1), (7, 3), (8, 0), (8, 1), (8, 2), (8, 3)]\
             and a xmax and xmin of (8, 5), and a ymax and ymin of (3, 0)"
    ...
    def test_flood_fill_two(self):
        ...
        #piece = the_board.board[8][8] They both work
    ...
    def test_find_neighbor_get_string_helper_startscoring(self):
        ...
        test_sb.making_go_board_strings(test_sb.black_set, cf.unicode_black, False)
        test_sb.making_go_board_strings(test_sb.white_set, cf.unicode_white, False)
        test_sb.making_go_board_strings(test_sb.empty_space_set, cf.unicode_none, False)
        piece = test_sb.board[6][1]
        neighbor = test_sb.board[6][2]
        output = test_sb.find_neighbor_get_string_helper(piece, neighbor, cf.unicode_white, test_sb.black_strings)
        ...
        output = test_sb.find_neighbor_get_string_helper(piece, neighbor, cf.unicode_black, test_sb.white_strings)
        assert output[0] is True
    ...
    def test_find_neighbor_get_string_helper_endgame(self):
        ...
        assert str(output[1]) == "this is a board string of color (0, 0, 0) and with len of 10 and values [(0, 5), (1, 5), (1, 6), (1, 7), (2, 6), (3, 6), (3, 7), (4, 7), (4, 8), (5, 8)]\
             and a xmax and xmin of (5, 0), and a ymax and ymin of (8, 5)"
        ...
        assert str(output[1]) == "this is a board string of color (255, 255, 255) and with len of 3 and values [(0, 7), (1, 8), (2, 8)]\
             and a xmax and xmin of (2, 0), and a ymax and ymin of (8, 7)"
    ...
    def test_find_neighbor_get_string_startscoring(self):
        ...
        test_sb.making_go_board_strings(test_sb.empty_space_set, cf.unicode_none, False)
        piece = test_sb.board[6][1]
        output = test_sb.find_neighbor_get_string(piece, cf.unicode_black)
        assert output[0] is True
        assert str(output[1]) == "this is a board string of color (0, 0, 0) and with len of 12 and values [(5, 0), (5, 1), (6, 0), (6, 2), (6, 3), (7, 0), (7, 1), (7, 3), (8, 0), (8, 1), (8, 2), (8, 3)]\
             and a xmax and xmin of (8, 5), and a ymax and ymin of (3, 0)"
        piece = test_sb.board[6][1]
        output = test_sb.find_neighbor_get_string(piece, cf.unicode_white)
        assert output[0] is True
        assert str(output[1]) == "this is a board string of color (255, 255, 255) and with len of 9 and values [(4, 0), (4, 1), (4, 2), (5, 2), (5, 3), (5, 4), (6, 4), (7, 4), (8, 4)]\
             and a xmax and xmin of (8, 4), and a ymax and ymin of (4, 0)"
    ...
    def test_dealing_with_dead_stones_fullgame(self):
        ...
        sucesss, original_string = test_sb.find_neighbor_get_string(piece, cf.unicode_black)
        for item in locations:
            piece = test_sb.board[item[0]][item[1]]
            sucesss, original_string = test_sb.find_neighbor_get_string(piece, cf.unicode_black)
            assert sucesss is True
            truth, connected, disconn = test_sb.finding_correct_mixed_string(piece, cf.unicode_black, original_string,
        ...
        for item in locations:
            ...
            sucesss, original_string = test_sb.find_neighbor_get_string(piece, cf.unicode_black)
            assert sucesss is True
            truth, connected, disconn = test_sb.finding_correct_mixed_string(piece, cf.unicode_black,
