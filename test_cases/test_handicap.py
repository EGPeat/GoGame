...
class TestClassPyTestHandicap:
    ...
    def test_automatic_placement(self, mock_switch_p, mock_refresh, mock_play_piece, mock_draw_circle, startup_goboard, amount):
        ...
        startup_goboard.go_board.whose_turn.unicode = hand.cf.unicode_black
    ...
    def test_handle_special_events_no_special_event(self, mock_handle_special_events):  # Redo
        go_board = MagicMock()
    ...
    def test_handle_special_events_with_special_event(self, ui_popup, mock_read_window):  # Redo
        self.go_board = MagicMock()
    ...
    def test_handle_exit_or_resume_exit_game(self, mock_normal_turn_options):  # Redo
        go_board = MagicMock()
